...
class Zebra_Pagination
{
     ...
     *
     *  Read more on the subject on {@link http://googlewebmastercentral.blogspot.com/2013/04/to-slash-or-not-to-slash.html Google Webmasters's official blog}.
     *
     *  <code>
     ...
     * @param array $rowset
     */
    function set_rowset(array $rowset)
    {
    	$this->rowset = $rowset;
    }
